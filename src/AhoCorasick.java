 ...
 */
  public class AhoCorasick {
    /**Aho-Corasick Algorithm finds all words in O(length of text + total number of char in words + total number of occurrences of words in text) time where z is total number of occurrences of words in text.**/
